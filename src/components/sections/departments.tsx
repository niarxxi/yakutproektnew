...
export const Departments = ({
  ...
  if (!mounted) {
    return (
      <section id="departments" className="relative py-20 overflow-hidden" role="region" aria-label="Отделы компании">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">
              14 специализированных отделов объединяют более 150 профессионалов для комплексного подхода к
              проектированию
            </p>
          </div>
        ...
        <div className={cn("max-w-sm md:max-w-6xl mx-auto px-4 md:px-8 lg:px-12", className)}>
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
                        ...
                        <Image
                          src={
                            ...
                            `/placeholder.svg?height=400&width=600&text=${
                              encodeURIComponent(department.name) || "/placeholder.svg" || "/placeholder.svg"
                            }`
                          }
              ...
              {/* Mobile Navigation */}
              <div className="flex lg:hidden justify-center gap-4 mt-6">{navigationButtons}</div>
            </div>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div className="min-h-[200px]">
                      <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Специализации:</h4>
          ...
          <div className="mt-8 lg:mt-12">
            ...
            <div className="hidden lg:flex justify-center gap-4 mb-6">{navigationButtons}</div>

            {/* Dots indicator - независимая позиция */}
            <div className="flex justify-center gap-2" role="tablist">
              {departments.map((_, index) => (
                <DotIndicator key={index} isActive={index === active} onClick={() => goToSlide(index)} />
              ))}
            </div>
          </div>
        </div>
